frappe.ui.form.on('Address', {
    ...
    address_line1: function (frm) { frm.trigger('update_full_address'); },
    address_line2: function (frm) { frm.trigger('update_full_address'); },
    city: function (frm) { frm.trigger('update_full_address'); },
    state: function (frm) { frm.trigger('update_full_address'); },
    country: function (frm) { frm.trigger('update_full_address'); },
    pincode: function (frm) { frm.trigger('update_full_address'); },
